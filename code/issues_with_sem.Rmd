...
sim_sorting_effect <- function(func, reps = 100, size = 52, baseline = 0.2, fid_scale = 0.1, sepsis_scale = 1, micro_scale = 1){
  sim_mult <- do.call("rbind", lapply(X = seq(1:reps), FUN = func, 
                                      baseline = baseline, size = size, 
                                      fid_scale = fid_scale, sepsis_scale = sepsis_scale, micro_scale = micro_scale))
...
sim_sorting <- function(func, reps = 100, size = 52, baseline = 0.2, fid_scale = 0.1){
  sim_mult <- do.call("rbind", lapply(X = seq(1:reps), FUN = func, 
                                      baseline = baseline, size = size, 
                                      fid_scale = fid_scale))
  sim_mult2 <- lapply(sim_mult, as.numeric)
...
extractor <- function(data){
  ...
  all_data2 <- all_data %>%
    separate(name, c("fid_scale", "sample_size"), sep = "_") %>%
    mutate(fid_scale = as.numeric(substr(fid_scale, 2, nchar(fid_scale))),
...
runit <- function(func){
  ...
  #nine months
  sim_0_39 <- sim_sorting(func = func, reps = 100, fid_scale = 0, size = 39)
  sim_1_39 <- sim_sorting(func = func, reps = 100, fid_scale = 0.01, size = 39)
  sim_2_39 <- sim_sorting(func = func, reps = 100, fid_scale = 0.025, size = 39)
  sim_4_39 <- sim_sorting(func = func, reps = 100, fid_scale = 0.04, size = 39)
  sim_6_39 <- sim_sorting(func = func, reps = 100, fid_scale = 0.06, size = 39)
  sim_9_39 <- sim_sorting(func = func, reps = 100, fid_scale = 0.09, size = 39)

  
  #one year
  sim_0_52 <- sim_sorting(func = func, reps = 100, fid_scale = 0, size = 52)
  sim_1_52 <- sim_sorting(func = func, reps = 100, fid_scale = 0.01, size = 52)
  sim_2_52 <- sim_sorting(func = func, reps = 100, fid_scale = 0.025, size = 52)
  sim_4_52 <- sim_sorting(func = func, reps = 100, fid_scale = 0.04, size = 52)
  sim_6_52 <- sim_sorting(func = func, reps = 100, fid_scale = 0.06, size = 52)
  sim_9_52 <- sim_sorting(func = func, reps = 100, fid_scale = 0.09, size = 52)

  #18 months
  sim_0_78 <- sim_sorting(func = func, reps = 100, fid_scale = 0, size = 78)
  sim_1_78 <- sim_sorting(func = func, reps = 100, fid_scale = 0.01, size = 78)
  sim_2_78 <- sim_sorting(func = func, reps = 100, fid_scale = 0.025, size = 78)
  sim_4_78 <- sim_sorting(func = func, reps = 100, fid_scale = 0.04, size = 78)
  sim_6_78 <- sim_sorting(func = func, reps = 100, fid_scale = 0.06, size = 78)
  sim_9_78 <- sim_sorting(func = func, reps = 100, fid_scale = 0.09, size = 78)


  #four years
  sim_0_208 <- sim_sorting(func = func, reps = 100, fid_scale = 0, size = 208)
  sim_1_208 <- sim_sorting(func = func, reps = 100, fid_scale = 0.01, size = 208)
  sim_2_208 <- sim_sorting(func = func, reps = 100, fid_scale = 0.025, size = 208)
  sim_4_208 <- sim_sorting(func = func, reps = 100, fid_scale = 0.04, size = 208)
  sim_6_208 <- sim_sorting(func = func, reps = 100, fid_scale = 0.06, size = 208)
  sim_9_208 <- sim_sorting(func = func, reps = 100, fid_scale = 0.09, size = 208)
...
runeffect <- function(func){
 ...
 fid_scale <- c(rep(0.02, 9),
          rep(0.04, 9),
          rep(0.06, 9))
 micro_scale <- rep(c(0.5, 0.5, 0.5,
                      0.75, 0.75, 0.75,
                      1, 1, 1), 3)
 sepsis_scale = rep(c(0.5, 0.75, 1), 9)
 ...
 all_runs <- mapply(FUN = sim_sorting_effect, 
  ...
  all_data2 <- cbind(fid_scale, micro_scale, sepsis_scale, all_data)
  all_data3 <- all_data2 %>%
    pivot_longer(cols = c("chip_good",
                          "chip_acc",
                          "rmsea_good",
...
Things to do: 
 ...
 - fiddle with effect sizes - should be more effect on fidelity and less on sepsis etc. 
...
The effect of IPC interventions on fidelity were simulated by an $rbeta$ distribution, with the following parameters. 

The mean of random values for rbeta distribution is calculated by:

$$\bar{x} = \frac{\alpha}{\alpha + \beta}$$

$\beta$ was calculated as $100 - \alpha$. The mean effect size for the effect of the IPC intervention on fidelity is calculated by: 

$$\bar{x}_{effect} = \frac{\alpha_1}{\alpha_1 + \beta_1} - \frac{\alpha_2}{\alpha_2 + \beta_2}$$

Where $\alpha_1 = 1 \times scale_f + baseline$ and $\beta = 100 - \alpha$ and represents the situation in which an IPC intervention is "on". $\alpha_2 = 0 \times scale + baseline$ and $\beta_2 = 100 - \alpha_2$ represents the situation in which it is "off". The effect of the interventions on fidelity can be altered by changing the value of $scale_f$. 


2) Fidelity on microbiology

The effect of changes in fidelity on microbiology is simulated as a $multivariate \hspace{0.2cm}normal$ with the following parameters contributing to the means of the multivariate distribution. The equation below is repeated for each microbiological "area". The value for each area is then calculated using the $multivariate \hspace{0.2cm}normal\hspace{0.2cm}distribution$

$$\bar{x_i} = \alpha_i -\beta_{mi}f_i $$
$\alpha_1$ represents the maximum value for the microbiology, and is set at 15, which is the approximate value for the highest $log(m)$ values that we are likely to find. The effect of changes in fidelity can be altered by changing the value of $\beta_{mi}$. The variance/covariance matrix $(\sigma)$ is set so that the diagonals are  0.2 and the off-diagonals are 0.1. 

3) Microbiology on sepsis

This is also simulated using an $rbeta$ distribution. For this the $\alpha$ and $\beta$ are calculated as: 

$$\alpha_s = (\beta_1 m_1 + \beta_2 m_2 ... + \beta_i m_i) \div 2$$
$$\beta_s = 15 \times n_m - \alpha_s$$
Where $micro_i$ represents the microbiology results from each of the areas of the ward. The value for $\alpha_s$ is divided by 2 as values below 50% for sepsis are more realistic than values approaching 100%. $n_m$ represents the number of different ward areas. This value is multiplied by 15 to get the theoretical maximum for the microbiology values. The effect of changes in microbiology on sepsis can be altered by changing the value of $\beta_i$.


```{r effect size, echo = FALSE, warning = FALSE, message = FALSE}
#simulating data ----
sem_env_effects <- function(x, size = 52, baseline = 0.2, fid_scale = 0.1, micro_scale, sepsis_scale){
  ...
  #covariance matrix
  sigma_2 <- matrix(c(0.2, 0.1, 
                      0.1, 0.2), ncol = 2)
  
  mv_3 <- function(x, y, z, sigma = sigma_3, mv_scale = micro_scale, ...){
    mv_scale <- 15 * mv_scale
  ...
  alpha_hands <- ((int_h1 + int_h2 + int_h3) * fid_scale + baseline) * 100
  alpha_hands[alpha_hands<0] <- 0
  alpha_hands[alpha_hands>100] <- 100
  beta_hands <- 100 - alpha_hands
  #environment
  ...
  alpha_env <- ((int_e1 + int_e2 + int_e3) * fid_scale + baseline) * 100
  alpha_env[alpha_env<0] <- 0
  alpha_env[alpha_env>100] <- 100
  beta_env <- 100 - alpha_env
  #this represents the average change in fidelity based on turning an intervention on or off
  change_fid <- fid_scale
  ...
  mv_env <- mapply(FUN = mv_3, x = fid_cot, y = fid_floor, 
                   z = fid_surf, MoreArgs = list(sigma = sigma_3, mv_scale = micro_scale))
  micro_cot <- mv_env[1, ]
  micro_floor <- mv_env[2, ]
  micro_surf <- mv_env[3, ]
  #this represents the change in microbiology based on increasing fidelity across one area by 10%
  change_micro <- 0.1 * (-micro_scale) 
  #micro_scale <- -(change_micro) / 0.1
  #hands
  mv_hands <- mapply(FUN = mv_2, x = fid_staff, y = fid_mat, 
                     MoreArgs = list(sigma = sigma_2, mv_scale = micro_scale))
  micro_staff <- mv_hands[1, ]
  micro_mat <- mv_hands[2, ]
  #sepsis
  max <- 15 * 5
  alpha_sepsis <- (micro_cot + micro_floor + micro_surf + micro_staff + micro_mat) * sepsis_scale / 2
  beta_sepsis <- max - alpha_sepsis
  alpha_sepsis[alpha_sepsis<0] <- 0
  beta_sepsis[beta_sepsis<0] <- 0
  sepsis <- rbeta(size, alpha_sepsis, beta_sepsis)
  #this represents the average change in sepsis based on a decrease in microbiology of 2 log in all areas
  change_sepsis <- sepsis_scale/(2*max) 
  #sepsis_scale <- change_sepsis * 2 * max
  #creating data frame
  df_ipc <- data.frame(
    #weeks = weeks,
    int_e1 = int_e1,
...
effects <- data_effects %>%
  ...
  mutate(change_fid = 100 * change_fid,
         change_sepsis = 100 * change_sepsis)
...
The effect of changing microbiology on sepsis (facets) represents the % change in sepsis based on a 2 log drop in all areas of microbiology.

### Plotting a time series of the variables for interest

```{r time series, echo = FALSE, warning = FALSE}

sim_timeseries <- function(reps = 100, size = 52, baseline = 0.2, fid_scale = 0.1, micro_scale = 1, sepsis_scale = 1){
  ...
  microcot_stats <- sapply(microcot_all / 15, FUN = quantile)
  microcot_stats2 <- as.data.frame(t(microcot_stats))
...
```{r improvements, echo = FALSE, warning = FALSE, message = FALSE, eval = FALSE}
#simulating data ----
sem_env_improved <- function(x, size = 52, baseline = 20, fid_scale = 10){
